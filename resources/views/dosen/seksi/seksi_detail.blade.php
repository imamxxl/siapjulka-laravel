...
@section('isi-konten')
    ...
    <section class="content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="box-body">
                                ...
                                <strong><i class="fa fa-bank margin-r-5"></i> Jurusan </strong>
                                <p class="text-muted">
                                    {{ $data->nama_jurusan }}
                                </p>
                                ...
                                <strong><i class="fa fa-file-text margin-r-5"></i> Seksi </strong>
                                <p name="seksi" class="text-muted">
                                    {{ $data->kode_seksi }}
                                </p>

                                <hr>

                                <strong><i class="fa fa-book margin-r-5"></i> Matakuliah </strong>
                                <p class="text-muted">{{ $data->nama_mk }}</p>

                                <hr>

                                <strong><i class="fa fa-thumb-tack margin-r-5"></i> Mutu </strong>
                                <p class="text-muted">{{ $data->sks }} SKS</p>

                                <hr>

                                <strong><i class="fa fa-user margin-r-5"></i> Dosen </strong>
                                <p class="text-muted">{{ $data->nama_dosen }}</p>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box-body">
                                ...
                                <p class="text-muted">{{ $data->kode_ruang }}</p>

                                <hr>

                                <strong><i class="fa fa-calendar margin-r-5"></i> Hari </strong>
                                <p class="text-muted">{{ $data->hari }}</p>

                                <hr>

                                <strong><i class="fa fa-clock-o margin-r-5"></i> Jam </strong>
                                <p class="text-muted">{{ $data->jadwal_mulai }} -
                                    {{ $data->jadwal_selesai }} </p>

                                <hr>

                                <strong><i class="fa fa-unlock-alt margin-r-5"></i> Token </strong>
                                <p class="text-muted">{{ $data->token }}</p>
        ...
        <div class="row">
            <div class="box">
                <div class="box-header">
                    @foreach ($seksi as $item)
                        <h3 class="box-title center">Daftar Peserta Matakuliah {{ $data->nama_mk }}</h3>
                    @endforeach
                </div>
                                    ...
                                    @else
                                        <td>
                                            <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                                                data-target="#modal-verifikasi{{ $data->id }}">
            ...
            <div>
                <a class="btn btn-primary" href="/seksi_dosen"> Kembali </a>
            </div>
        ...
        @foreach ($participant as $data)
            <div class="modal fade" id="modal-verifikasi{{ $data->id }}">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="/seksi_dosen/hapus_peserta/{{ $data->id_participant }}"
