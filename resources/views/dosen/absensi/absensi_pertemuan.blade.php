        ...
        <div class="modal fade" id="modal-recovery-qrcode">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form
                            action="/recovery_dosen/qrcode/absensi/{{ $data->id_seksi }}/pertemuan/{{ $data->id_pertemuan }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <P> Jika anda telah menghapus data ini, semua data absensi pada pertemuan ini akan dihapus secara
                            PERMANEN. <br> Perlu diingat!, data yang telah dihapus tidak dapat di kembalikan lagi.</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Batal</button>
                        <a href="/delete_dosen/seksi/{{ $data->id_seksi }}/pertemuan/{{ $data->id_pertemuan }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <P>Pastikan anda telah melakukan pengecekan terhadap semua data absensi mahasiswa pada pertemuan ini
                            sebelum melakukan verifikasi menyeluruh.
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Batal</button>
                        <a href="/absensi_dosen/verifikasi_all/seksi/{{ $data->id_seksi }}/pertemuan/{{ $data->id_pertemuan }}"
