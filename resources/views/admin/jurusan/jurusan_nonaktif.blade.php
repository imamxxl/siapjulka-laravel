        ...
        <div class="row">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title center">Data Jurusan Non-Aktif</h3>
                </div>
                <!-- /.box-header -->
                ...
                <div class="card-body box-body table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-sm btn-success" data-toggle="modal"
                                            data-target="#modal-aktif{{ $data->kode_jurusan }}">
                    ...
                    <!-- Modals Aktif -->
                    @foreach ($jurusan as $data)
                        <div class="modal fade" id="modal-aktif{{ $data->kode_jurusan }}">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title"> Aktifkan {{ $data->nama_jurusan }} </h4>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a href="/jurusan/aktif/{{ $data->kode_jurusan }}"
            ...
            <div>
                <a class="btn btn-primary" href="/jurusan"> Kembali </a>
            </div>
