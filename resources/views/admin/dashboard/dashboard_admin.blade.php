...
@section('bagian-nav')
    @include('layout.nav.nav-dashboard')
@endsection
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-primary">
                    ...
                    <a href="/matakuliah" class="small-box-footer">Lihat Selengkapnya <i
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-yellow">
                    ...
                    <a href="/seksi" class="small-box-footer">Lihat Selengkapnya <i
                            class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    ...
                    <a href="/ruang" class="small-box-footer">Lihat Selengkapnya <i
                            class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
        </div>
