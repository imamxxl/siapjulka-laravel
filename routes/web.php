...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['admin'])->group(function () {
        ...
        Route::get('/download/pdf{id_absensi}', [AbsensiController::class, 'downloadPDF']);
    ...
    Route::middleware(['dosen'])->group(function () {
        // Dashboard
        Route::get('/dashboard_dosen', [DashboardDosenController::class, 'index']);
    ...
    Route::middleware(['mahasiswa'])->group(function () {
        // Dashboard
        Route::get('/dashboard_mahasiswa', [DashboardMahasiswaController::class, 'index']);
