...
class AbsensiController extends Controller
{
    ...
    function index(Request $request)
    {
        ...
        $cek_seksi = Seksi::all()->where('status', '1')->count();
        ...
        return view('admin.absensi.manajemen_absensi', compact('seksi', 'cek_seksi', 'participant'));
    }
    ...
    function lihatPeserta($id)
    {
        ...
        return view('admin.absensi.absensi_lihat_peserta', compact('seksi', 'participant', 'seksi', 'mahasiswa'));
    }
    ...
    function detailAbsensi($id)
    {
        ...
        // link tambah peserta
        $link_tambah_peserta = "/absensi/lihat_peserta/$id";
        ...
        return view('admin.absensi.absensi_detail', compact(
            'deteksi_participant',
            'link_tambah_peserta',
            'color',
            'color_hitung',
    ...
    function detailPertemuan($id_seksi, $id_pertemuan)
    {
        ...
        return view('admin.absensi.absensi_pertemuan', compact(
            'seksi',
            'kode_seksi',
            'absensis',
            'pertemuan',
    ...
    function printPertemuan($id_seksi, $id_pertemuan)
    {
        ...
        // parsing data
        return view('admin.print.print_absensi_pertemuan', compact(
            'absensis',
            'prodi',
            'sks',
            'dosen',
    ...
    function printPerSemester($id_seksi)
    {
        ...
        return view('admin.print.print_absensi_persemester', compact(
            'absensis',
            'matakuliah',
            'get_kode_seksi',
            'get_tahun',
    ...
    function printPerMatakuliah()
    {
        ...
        $deteksi_seksi = DB::table('absensis')
            ->groupBy('id_seksi')
            ->pluck('id_seksi');

        // melakukan perulangan untuk kalkulasi peserta yang izin di id_seksi tertentu
        $hitung_absensi_total = [];
        for ($i = 0; $i < count($deteksi_seksi); $i++) {
            $hitung_absensi_total[] = DB::table('absensis')
                ->where('absensis.id_seksi', '=', $deteksi_seksi[$i])
                ->count();
        }

        // melakukan perulangan untuk kalkulasi peserta yang hadir di id_seksi tertentu
        $hitung_absensi_hadir = [];
        for ($i = 0; $i < count($deteksi_seksi); $i++) {
            $hitung_absensi_hadir[] = DB::table('absensis')
                ->where('keterangan', 'hadir')
        ...
        // melakukan perulangan untuk kalkulasi peserta yang alfa di id_seksi tertentu
        $hitung_absensi_alfa = [];
        for ($i = 0; $i < count($deteksi_seksi); $i++) {
            $hitung_absensi_alfa[] = DB::table('absensis')
